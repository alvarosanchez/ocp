...
For repository storage and registry shape, see [Configuration and paths](/docs/reference/configuration-and-paths/).
...
For the profile metadata shape, see [Configuration and paths](/docs/reference/configuration-and-paths/).
