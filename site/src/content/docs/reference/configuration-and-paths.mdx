...
- [Repositories and profiles](../concepts/repositories-and-profiles/) for the higher-level mental model.
- [Profile inheritance](./profile-inheritance/) for merge and precedence rules.
- [Repository commands](./commands/repository/) for add, create, delete, list, and refresh behavior.
