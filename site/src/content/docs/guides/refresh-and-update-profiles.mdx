...
For the command behavior and output details, see [Repository commands](/docs/reference/commands/repository/) and [Common failures](/docs/troubleshooting/common-failures/).
