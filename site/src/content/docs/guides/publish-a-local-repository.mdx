...
For the exact publish conditions and defaults, see [Repository commands](/docs/reference/commands/repository/) and [Configuration and paths](/docs/reference/configuration-and-paths/).
