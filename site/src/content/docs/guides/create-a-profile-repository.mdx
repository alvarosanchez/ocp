...
For the resulting on-disk shape and metadata rules, see [Repositories and profiles](../concepts/repositories-and-profiles/) and [Configuration and paths](../reference/configuration-and-paths/).
